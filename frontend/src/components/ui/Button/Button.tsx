...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary: [
    ...
    'hover:bg-[var(--surface-hover)] hover:border-zinc-400 dark:hover:border-zinc-600',
  ...
  outline: [
    ...
    'border border-[var(--surface-border)]',
    'hover:bg-[var(--surface-elevated)] hover:border-zinc-400 dark:hover:border-zinc-600',
    'focus-visible:ring-brand-500/30',
    'disabled:opacity-40 disabled:cursor-not-allowed',
  ].join(' '),
  ghost: [
