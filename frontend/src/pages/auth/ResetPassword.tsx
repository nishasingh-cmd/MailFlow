    ...
    return (
      <Card className="w-full bg-[var(--surface-card)] border border-[var(--surface-border)] shadow-elevation-2 p-6 sm:p-8">
        <div className="text-center py-4 space-y-4 animate-fade-in">
          <div className="w-12 h-12 rounded-full bg-amber-500/15 text-amber-400 flex items-center justify-center mx-auto text-xl">
            ⚠️
          </div>
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            {password && confirmPassword && password !== confirmPassword && (
              <p className="text-2xs text-red-400 font-medium">⚠️ Passwords do not match</p>
            )}
